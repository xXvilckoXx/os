...
//! reads from hardware device port
extern  unsigned short	_cdecl	inportw (unsigned short id);

//! writes byte to hardware port
extern	void			_cdecl	outportw (unsigned short id, unsigned short value);

//! reads from hardware device port
extern	unsigned int	_cdecl	inportd (unsigned int id);

//! writes byte to hardware port
extern	void			_cdecl	outportd (unsigned short id, unsigned int value);
